...
<form action="script.php" method="post"><!--script.php será responsável por processar os dados que forem enviados dentro desse formulário atráves do method=POST-->
    <?php
        $mensagemDeSucesso = isset($_SESSION['mensagem-de-sucesso']) ? $_SESSION['mensagem-de-sucesso'] : '';//verifica se a variavel de sessão foi iniciada, se foi, seta mensagem-de-erro, senão, vazio e segue abaixo
